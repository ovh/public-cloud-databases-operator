...
func ListAuthorizedIps(ctx context.Context, r *ServiceReconciler, projectId string, serviceId string) ([]string, error) {
	var response Resp
	ips := make([]string, 0)
...
func GetEngineForServiceId(ctx context.Context, r *ServiceReconciler, projectId string, serviceId string) (string, error) {
